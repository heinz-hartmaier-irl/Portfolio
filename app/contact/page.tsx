...
export default async function ContactPage() {
  ...
  const content = siteContent[locale].pages.contact;
  ...
  return (
    <PageShell eyebrow={content.eyebrow} title={content.heading} description={content.description}>
      <div className="grid gap-4 lg:grid-cols-[0.9fr_1.1fr]">
        <SectionCard>
          <h2 className="text-2xl font-semibold text-text">{content.linksTitle}</h2>
        ...
        <SectionCard>
          <form className="space-y-4">
            <div>
              <label htmlFor="name" className="text-sm text-muted">{content.form.name}</label>
            ...
            <div>
              <label htmlFor="email" className="text-sm text-muted">{content.form.email}</label>
            ...
            <div>
              <label htmlFor="message" className="text-sm text-muted">{content.form.message}</label>
